    ...
    return (
        <div className='flex-1'>
            ...
            <div className="bg-white py-24 sm:py-32">
                ...
                <li>
                <p><strong>Website</strong> refers to iSorry.lol, accessible from <a href="https://isorry.lol" rel="external nofollow noopener" target="_blank">https://isorry.lol</a></p>
                </li>
                <li>
                ...
                <ul>
                <li>By visiting this page on our website: <a href="https://isorry.lol/contact" rel="external nofollow noopener" target="_blank">https://isorry.lol/contact</a></li>
                </ul>
            </div>
            </div>
            </div>
