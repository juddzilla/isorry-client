      ...
      <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-24">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
          ...
          <div className="mt-24 sm:mt-32 lg:mt-16">
            <Link to="/anatomy" className="inline-flex space-x-6">
          ...
          <div className="mt-10 flex items-center gap-x-6">
            <Link
              to="/apologize"
              className="rounded-md bg-brand px-3.5 py-2.5 text-sm font-semibold shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
              Let's Do It
            </Link>
